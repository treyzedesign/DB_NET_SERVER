...
const { postFile , getAllFiles, getUserFile} = require('../controller/PostController')
...
PostRouter.post('/postFile', AuthUser, upload.array('files'), postFile)
PostRouter.get('/getAllFiles', AuthUser, getAllFiles)
PostRouter.get('/getUserFile', AuthUser, getUserFile)
